...
public class MusicListActivity extends AppCompatActivity {
    ...
    private CustomAdapter m_Adapter; // 메인 어댑터
...
//        // Get JSON values from previous intent
        ...
        m_ListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String title = ((TextView) view.findViewById(R.id.txt_title))
                        .getText().toString();
                String artist = ((TextView) view.findViewById(R.id.txt_artist))
                        .getText().toString();
                String genre = ((TextView) view.findViewById(R.id.txt_genre))
                        .getText().toString();


                Item item = (Item)m_Adapter.getItem(position);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            m_Adapter = new CustomAdapter(MusicListActivity.this, alist); // 메인 어댑터 생성
